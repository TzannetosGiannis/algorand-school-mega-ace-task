...
def test_accept_loan(create_app, opt_in, opt_in_nft, request_loan, accept_loan):
    app_acct_info = algod_client.account_info(borrower.address)
    asset = (
        str(app_acct_info["assets"][-1]["asset-id"])
        + "_"
    ...
    assert asset == str(asa2) + "_" + str(initial_amount + request_amount)


# @pytest.mark.accept_loan
# def test_accept_loan2(create_app, opt_in, opt_in_nft, request_loan, accept_loan):
#     print(
#         app_client.get_local_state(borrower.address),
#         lender.address,
#         borrower.address,
#         app_addr,
#     )
#     assert app_client.get_local_state(borrower.address)["lender"] == lender.address
...
def test_liquidate(
    ...
    assert app_client.get_local_state(borrower.address)["duration"] > 0
